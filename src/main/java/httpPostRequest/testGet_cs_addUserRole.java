 ...
 * 
 * */
public class testGet_cs_addUserRole {
	...
	public static void main(String[] args) throws Exception {
		...
		url = "http://127.0.0.1:8080/adduserrole?username=admin3&role=13" ;
		//url = "http://127.0.0.1:8080/adduserrole?username=admin&role=1" ;
