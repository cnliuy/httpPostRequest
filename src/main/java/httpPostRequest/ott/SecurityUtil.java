...
//		}
	 ...
	 * @return 明文
	 */
	public static String decryptAESByPasswd(String passwd , String encryptResultStr) {
//		if (StringUtils.isEmpty(encryptResultStr)) {
//			//throw new ParamException("密文不能为空");
//			System.out.println("密文不能为空");
//		}
		// BASE64位解密
		try {
	 ...
	 * @return 密文
	 */
	public static String encryptAESByPasswd(String passwd ,String content) {
//		if (StringUtils.isEmpty(content)) {
//			//throw new ParamException("明文不能为空！");
//			System.out.println("明文不能为空！");
//		}
