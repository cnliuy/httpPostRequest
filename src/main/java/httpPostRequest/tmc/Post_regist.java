...
public class Post_regist {
	...
	public static void main(String[] args) throws Exception {
		...
		HttpPost httpPost = new HttpPost("http://localhost:6080/users/signup");
		...
		String parameters = "{\"username\":\"120101198705063021_18620007122\",\"phonenum\":\"18620007122\",\"usercardid\":\"120101198705063021\"}";
