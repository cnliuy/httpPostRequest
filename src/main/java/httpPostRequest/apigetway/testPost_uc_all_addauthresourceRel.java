 ...
 * 
 * */
public class testPost_uc_all_addauthresourceRel {
	...
	public static void main(String[] args) throws Exception {		
		...
		url = "http://127.0.0.1:8090/api/u/addResourceAuthRel" ;
		...
		String  parameters = "{\"resourceid\":\""+parm+ "\",\"authorityid\":\""+parm2+"\",\"vorder\":\""+parm3+"\" }";
