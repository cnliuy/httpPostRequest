 ...
 * 
 * */
public class testPost_uc_all_addauth {
	...
	public static void main(String[] args) throws Exception {		
		...
		url = "http://127.0.0.1:8090/api/u/addAuthority" ;
		...
		String parm = "ROLE_DBA2";
		String parm2 = "权限描述";
		String parm3 = "1";	   
		
 
		String  parameters = "{\"authname\":\""+parm+ "\",\"authdesc\":\""+parm2+"\",\"vorder\":\""+parm3+"\" }";
