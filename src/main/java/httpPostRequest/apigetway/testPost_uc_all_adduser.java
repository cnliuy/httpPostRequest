 ...
 * 
 * */
public class testPost_uc_all_adduser {
	...
	public static void main(String[] args) throws Exception {		
		...
		url = "http://127.0.0.1:8090/api/u/addUser" ;
		...
		String parm = "username4";
		String parm2 = "password4";
		String parm3 = "测试用户2";	     
		String  parameters = "{\"username\":\""+parm+ "\",\"password\":\""+parm2+"\",\"usernamedesc\":\""+parm3+"\" }";
