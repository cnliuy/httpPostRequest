 ...
 * 
 * */
public class testPost_uc_all_addresource {
	...
	public static void main(String[] args) throws Exception {		
		...
		url = "http://127.0.0.1:8090/api/u/addResource" ;
		...
		String parm = "资源名name1";
		String parm2 = "资源描述resourcedesc";
		String parm3 = "/api/u/u/test3**";	
		String parm4 = "4";	 

		
		
		String  parameters = "{\"type\":\""+parm4+ "\",\"resource\":\""+parm3+"\",\"name\":\""+parm+"\",\"resourcedesc\":\""+parm2+"\" }";
